...
ActiveRecord::Schema.define(version: 20150829191243) do
  ...
  add_index "organizations", ["user_id", "admin_id"], name: "index_organizations_on_user_id_and_admin_id", using: :btree
